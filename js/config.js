// ═══ TABULA RASA — config.js ═══
// All constants, palettes, tuning parameters

export const TW=30, TH=15, CH=16, CC=3, CS=CH*CC;
export const SPD=.048, SPRNT=.082, CLERP=.07, IR=2.2;

// District road/sidewalk/curb colors [downtown, industrial, residential]
...
// Building face palettes per district
export const DPAL=[
...
// Storefront base colors
export const DST=[[30,35,50],[38,30,25],[40,34,30]];

// Building signs per district
export const DSG=[
...
// Vehicle colors
export const VC=["#383850","#582828","#283828","#484838","#282848","#505050","#4a3828"];
